	...
	public function onDisplayField(&$field, &$item)
	{
		...
		if (!isset($js_added[$mapapi_edit]))
		{
			...
			if ($mapapi_edit === 'googlemap')
			{
				...
				/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-form', \Joomla\CMS\Uri\Uri::root() . (JDEBUG ? 'plugins/flexicontent_fields/addressint/js/form.js' : 'plugins/flexicontent_fields/addressint/js/form.min.js'), array('version' => FLEXI_VHASH));
			...
			elseif ($mapapi_edit === 'nominatim')
			{
				...
				/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-form_osm', \Joomla\CMS\Uri\Uri::root() . (JDEBUG ? 'plugins/flexicontent_fields/addressint/js/form_osm.js' : 'plugins/flexicontent_fields/addressint/js/form_osm.min.js'), array('version' => FLEXI_VHASH));
			}
		}
