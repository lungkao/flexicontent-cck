...
class plgFlexicontent_fieldsRelation extends FCField
{
	...
	public function onDisplayField(&$field, &$item)
	{
		...
		if (!$common_css_js_added)
		{
			...
			/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-form', \Joomla\CMS\Uri\Uri::root(true) . (JDEBUG ? '/plugins/flexicontent_fields/relation/js/form.js' : '/plugins/flexicontent_fields/relation/js/form.min.js'), array('version' => FLEXI_VHASH));
		}
