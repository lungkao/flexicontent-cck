...
class plgFlexicontent_fieldsFile extends FCField
{
	...
	public function onDisplayField(&$field, &$item)
	{
		...
		if ( $js_added === null )
		{
			...
			/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-form', \Joomla\CMS\Uri\Uri::root(true) . (JDEBUG ? '/plugins/flexicontent_fields/file/js/form.js' : '/plugins/flexicontent_fields/file/js/form.min.js'), array('version' => FLEXI_VHASH));
		}
