...
<?php endif;?>
	...
	<caption class="visually-hidden"><?php echo \Joomla\CMS\Language\Text::_('FLEXI_TAGS'); ?></caption>
	<thead>
		<tr>
			...
			<th scope="col" class="hideOnDemandClass center hidden-phone hidden-tablet" colspan="2">
