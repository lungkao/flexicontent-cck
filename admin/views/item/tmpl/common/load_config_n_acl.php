...
if ($tags_editable || (!$isSite && $this->perms['canversion']))
{
	...
	/* J5/J6 WebAsset: */ $this->document->getWebAssetManager()->registerAndUseScript('fc-jquery-pager', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'administrator/components/com_flexicontent/assets/js/jquery.pager.js' : 'administrator/components/com_flexicontent/assets/js/jquery.pager.min.js'), array('version' => FLEXI_VHASH));     // e.g. pagination for item versions
	/* J5/J6 WebAsset: */ $this->document->getWebAssetManager()->registerAndUseScript('fc-jquery-autogrow', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'administrator/components/com_flexicontent/assets/js/jquery.autogrow.js' : 'administrator/components/com_flexicontent/assets/js/jquery.autogrow.min.js'), array('version' => FLEXI_VHASH));  // e.g. autogrow version comment textarea

	///* J5/J6 WebAsset: */ $this->document->getWebAssetManager()->registerAndUseStyle('fc-jquery-autocomplete', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'components/com_flexicontent/librairies/jquery-autocomplete/jquery.autocomplete.css' : 'components/com_flexicontent/librairies/jquery-autocomplete/jquery.autocomplete.min.css'), array('version' => FLEXI_VHASH));
