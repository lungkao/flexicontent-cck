...
<?php
/* J5/J6 WebAsset: */ $this->document->getWebAssetManager()->registerAndUseScript('fc-layout_editor', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/js/layout_editor.js' : 'components/com_flexicontent/assets/js/layout_editor.min.js'), array('version' => FLEXI_VHASH));
?>
