...
var $proxy_option   = 'com_content';
	...
	function _displayCopyMove($tpl = null, $cid = array(), $behaviour = 'copymove')
	{
		...
		flexicontent_html::loadFramework('select2');
		/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-batchprocess', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/js/batchprocess.js' : 'components/com_flexicontent/assets/js/batchprocess.min.js'), array('version' => FLEXI_VHASH));
