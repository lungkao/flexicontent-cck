...
class JFormFieldSeparator extends JFormFieldSpacer
{
	...
	function add_tab_css_js()
	{
		...
		// Load JS tabber lib
		/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-tabber-minimized', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/js/tabber-minimized.js' : 'components/com_flexicontent/assets/js/tabber-minimized.min.js'), array('version' => FLEXI_VHASH));
		/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('fc-tabber', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/tabber.css' : 'components/com_flexicontent/assets/css/tabber.min.css'), array('version' => FLEXI_VHASH));
