...
{
	/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-favlist', \Joomla\CMS\Uri\Uri::base(true).(JDEBUG ? '/modules/mod_flexicontent/tmpl_common/js/favlist.js' : '/modules/mod_flexicontent/tmpl_common/js/favlist.min.js'));
