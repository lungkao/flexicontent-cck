...
class FLEXIcontentViewSearch extends \Joomla\CMS\MVC\View\HtmlView
{
	...
	function display( $tpl = null )
	{
		...
		if (!$params->get('disablecss', ''))
		{
			...
			/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('flexi_filters', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/flexi_filters.css' : 'components/com_flexicontent/assets/css/flexi_filters.min.css'), array('version' => FLEXI_VHASH));
