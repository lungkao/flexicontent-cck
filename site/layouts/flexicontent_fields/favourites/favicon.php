...
if (!$js_and_css_added)
{
	...
	/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-fcfav', \Joomla\CMS\Uri\Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/js/fcfav.js' : 'components/com_flexicontent/assets/js/fcfav.min.js'), array('version' => FLEXI_VHASH));
